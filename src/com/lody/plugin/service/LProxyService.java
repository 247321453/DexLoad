...
public class LProxyService extends Service {
	 ...
	 * 所有服务
	 */
	public static final Class<?>[] ALLSERVERS = new Class<?>[] { LProxyService.class, LProxyServiceMirror.class,
			LProxyService1.class, LProxyService2.class, LProxyService3.class };
	/***
	 * 插件服务
	 */
	public static final Class<?>[] SERVERS = new Class<?>[] { LProxyService1.class, LProxyService2.class,
	...
	public static Class<?> getService(Context context, String apkPath, String serviceClass, boolean onlyexist) {
		return getService(context, apkPath, serviceClass, onlyexist, ALLSERVERS);
	}
	...
	public static Class<?> getService(Context context, String apkPath, String serviceClass, boolean onlyexist,
		...
		for (Class<?> service : services) {
			...
			// apk
			String _apk = LProxyService.getPluginPath(context, service);
	...
	public void onCreate() {
		super.onCreate();
		String apkPath = getPluginPath(this, this.getClass());
		String serviceName = getPluginService(this, this.getClass());
		...
		if (isInit) {
			...
			setPluginService(this, this.getClass(), null, null);
			stopSelf();
		}
	}

	private boolean fillService(String apkPath, String serviceName) {
		if (TextUtils.isEmpty(apkPath)) {
			return false;
		}
		sSERVICE_APK_PATH = apkPath;
		sSERVICE_CLASS_NAME = serviceName;
		setPluginService(this, this.getClass(), apkPath, serviceName);
		try {
	...
	public ComponentName startService(Intent service) {
		...
		if (freeservice == null) {
			freeservice = LProxyServiceMirror.class;
		}
