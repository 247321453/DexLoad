...
public class Reflect {
	 ...
	 * @see #on(Class)
	 */
	public static Reflect on(String name) throws RuntimeException {
		return on(forName(name));
	}

	@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
	public static Reflect on(DexClassLoader classLoader, String name) {
		Class<?> cls = null;
		try {
	 ...
	 * @throws RuntimeException
	 */
	public Reflect set(String name, Object value) throws RuntimeException {
		try {
	 ...
	 * @throws RuntimeException
	 */
	public Reflect field(String name) throws RuntimeException {
		try {
			Field field = field0(name);
	 ...
	 */
	public Reflect call(String name) throws RuntimeException {
	 ...
	 * @throws RuntimeException
	 */
	public Reflect call(String name, Object... args) throws RuntimeException {
	 ...
	 * @throws RuntimeException
	 */
	public Reflect create(Object... args) throws RuntimeException {
		Class<?>[] types = types(args);
		args = reObjects(args);
		try {
