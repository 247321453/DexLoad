...
public class LActivityProxy extends Activity implements ILoadPlugin {
	...
	public ComponentName startService(Intent service) {
		...
		// 设置代理服务
		Class<?> freeservice = LProxyService.getService(this, pluginDexPath, serviceName, true);
		if (freeservice != null) {
			service.setClass(this, freeservice);
			super.stopService(service);
			LProxyService.setPluginService(this, freeservice, pluginDexPath, serviceName);
		} else {
			service.setClass(this, LProxyService.class);
			// 停止服务
			super.stopService(service);
			LProxyService.setPluginService(this, LProxyService.class, pluginDexPath, serviceName);
		}
		return super.startService(service);
	}
